  ...
  return (
    <div className="min-h-screen font-body bg-[#0a0a0f] text-white overflow-hidden relative">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center px-4 py-16 max-w-2xl mx-auto">
        <div className="mb-8 inline-flex items-center gap-2 px-4 py-2 rounded-full border border-violet-500/30 bg-violet-500/10 text-violet-300 text-sm font-medium animate-fade-in">
        ...
        {formState !== "success" ? (
          ...
          >
            ...
            <button
              ...
              style={{ background: "linear-gradient(135deg, #7c3aed 0%, #db2777 50%, #0891b2 100%)" }}
            >
